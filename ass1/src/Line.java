 ...
 * It stores start and end point and provides methods for measuring length, middle point
...
public class Line {
   ...
   /**
    * Constructs a new line object using the coordinates of the ends of the line segmant
   ...
   /**
    * Calculates the middle point by comparing the average of the x and y coordinates
   ...
   /**
    * helper method to calculate the "infinite" line slope of the line segmant using the slope formula
   ...
   /***
    * helper method to calculate the y-intercept of the "infinite" line representive of the line segmant using the formula
    ...
    * This method safely handles edge cases such as vertical lines (undefined slopes) and 
    * parallel lines. It also verifies that the calculated mathematical intersection point 
    ...
    * @return a new Point representing the exact intersection coordinate, or null if the lines 
    * do not intersect, are strictly parallel, or overlap in a way that yields infinite points
    */
    ...
    * of the points does not matter (a line from A to B is equal to a line from B to A).
    *
    * @param other the other Line object to compare against this line
    * @return true if the lines represent the exact same geometric segment, false otherwise
    */
