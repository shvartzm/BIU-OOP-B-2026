...
public class Point {
   ...
   /**
    * uses the x and y coordinates from the two points and uses the distance formula
   ...
   /**
    * Checks if this point is equal to another point by comparing their x and y coordinates.
    * This method uses a small threshold (EPSILON) to safely handle floating-point precision errors.
    * @param other the other Point object to compare against this point
    * @return true if the points are mathematically equal within the threshold, false otherwise
    */
